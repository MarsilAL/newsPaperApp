...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"bground.js":[function(require,module,exports) {
...
THREE.WebGLRenderer = function (a) {
  ...
  function i(a, b, c) {
    ...
    if (c) for (var k in a.attributes) {
  ...
  var wd = function wd(a) {
    ...
    if (void 0 !== a.geometryGroups) for (var c in a.geometryGroups) {
      ...
      if (void 0 !== d.numMorphTargets) for (var e = 0, f = d.numMorphTargets; e < f; e++) {
    ...
    if (a && a.__webglTexture) if (j.deleteTexture(a.__webglTexture), a instanceof THREE.WebGLRenderTargetCube) for (var b = 0; 6 > b; b++) {
          ...
          if (rd) {
            ...
            for (xd = rd.length; Vc < xd; Vc++) {
              if (Da = rd[Vc], Da.needsUpdate && (void 0 === Da.boundTo || "vertices" === Da.boundTo)) {
                za = 0;
                zc = Da.value.length;
                if (1 === Da.size) for (ib = 0; ib < zc; ib++) {
            ...
            if (sd) {
              ...
              for (Fd = sd.length; dd < Fd; dd++) {
                if (Ea = sd[dd], Ea.needsUpdate && (void 0 === Ea.boundTo || "vertices" === Ea.boundTo)) {
                  Ja = 0;
                  Ac = Ea.value.length;
                  if (1 === Ea.size) for (jb = 0; jb < Ac; jb++) {
...
THREE.AnimationHandler = function () {
  var a = [],
    ...
    parse: function parse(a) {
      var b = [];
      if (a instanceof THREE.SkinnedMesh) for (var c = 0; c < a.bones.length; c++) {
        b.push(a.bones[c]);
      } else d(a, b);
      return b;
    }
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","bground.js"], null)
//# sourceMappingURL=/bground.d9d6b3fd.js.map